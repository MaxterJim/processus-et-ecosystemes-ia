# =============================================================================
#  04-setup-venv-py311.ps1
#  Script d'installation automatique pour DÉBUTANTS sur Windows
#  >>> VERSION POUR PYTHON 3.11 (très stable, recommandé pour TensorFlow) <<<
#  -----------------------------------------------------------------------------
#  Ce script :
#    1. Vérifie que Python 3.11 est installé
#    2. Crée (si absent) un environnement virtuel "myfastapienv-py311"
...
#     .\scripts\04-setup-venv-py311.ps1
#
...
try {
    ...
    Write-Host "  1. Allez sur https://www.python.org/downloads/release/python-3110/"
...
pip freeze | Out-File -Encoding utf8 "requirements-py311.txt"
Write-OK "Fichier 'requirements-py311.txt' généré à la racine du projet."
...
if ($MyInvocation.InvocationName -ne ".") {
    ...
    Write-Host "    . .\scripts\04-setup-venv-py311.ps1" -ForegroundColor Yellow
    Write-Host ""
}
