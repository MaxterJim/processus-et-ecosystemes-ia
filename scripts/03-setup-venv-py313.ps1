# =============================================================================
#  03-setup-venv-py313.ps1
#  Script d'installation automatique pour DÉBUTANTS sur Windows
#  >>> VERSION POUR PYTHON 3.13 <<<
#  -----------------------------------------------------------------------------
#  Ce script :
#    1. Vérifie que Python 3.13 est installé
#    2. Crée (si absent) un environnement virtuel "myfastapienv-py313"
...
#     .\scripts\03-setup-venv-py313.ps1
#
...
try {
    ...
    Write-Host "  1. Allez sur https://www.python.org/downloads/release/python-3130/"
...
pip freeze | Out-File -Encoding utf8 "requirements-py313.txt"
Write-OK "Fichier 'requirements-py313.txt' généré à la racine du projet."
...
if ($MyInvocation.InvocationName -ne ".") {
    ...
    Write-Host "    . .\scripts\03-setup-venv-py313.ps1" -ForegroundColor Yellow
    Write-Host ""
}
